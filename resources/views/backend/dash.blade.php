                ...
                <nav class="navbar-custom">
                    <ul class="list-inline float-right mb-0"><!-- language-->
                        <li class="list-inline-item dropdown notification-list hide-phone"><a
                                ...
                                aria-expanded="false">English <img src="{{ asset('assets/images/flags/us_flag.jpg') }}"
                                    class="ml-2" height="16" alt=""></a>
                            <div class="dropdown-menu dropdown-menu-right language-switch"><a class="dropdown-item"
                                    href="#"><img src="{{ asset('assets/images/flags/italy_flag.jpg') }}" alt=""
                                        height="16"><span>Italian </span></a><a class="dropdown-item" href="#"><img
                                        src="{{ asset('assets/images/flags/french_flag.jpg') }}" alt="" height="16"><span>French
                                    </span></a><a class="dropdown-item" href="#"><img
                                        src="{{ asset('assets/images/flags/spain_flag.jpg') }}" alt="" height="16"><span>Spanish
                                    </span></a><a class="dropdown-item" href="#"><img
                        ...
                        <li class="list-inline-item dropdown notification-list"><a
                                ...
                                data-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                aria-expanded="false"><img src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt="user"
            ...
            <div class="page-content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-4">
                            <div class="card bg-white m-b-30"><img src="{{ asset('assets/images/widgets/wather.jpg') }}" alt=""
                                    class="img-fluid">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt="user"
                                                            width="40"></td>
                                                    <td><a href="javascript:void(0);">Ruby T. Curd</a></td>
                                                    <td><img src="{{ asset('assets/images/flags/us_flag.jpg') }}" alt=""
                                                            style="width:30px"></td>
                                                    <td>$100</td>
                                                    <td>10</td>
                                                ...
                                                <tr>
                                                    <td><img class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt="user"
                                                            width="40"></td>
                                                    <td><a href="javascript:void(0);">William A. Johnson</a></td>
                                                    <td><img src="{{ asset('assets/images/flags/french_flag.jpg') }}" alt=""
                                                            style="width:30px"></td>
                                                    <td>$490</td>
                                                    <td>24</td>
                                                    <td><i class="mdi mdi-star text-warning"></i> <i
                                                ...
                                                <tr>
                                                    <td><img class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt="user"
                                                            width="40"></td>
                                                    <td><a href="javascript:void(0);">Bobby M. Gray</a></td>
                                                    <td><img src="{{ asset('assets/images/flags/spain_flag.jpg') }}" alt=""
                                                            style="width:30px"></td>
                                                    <td>$380</td>
                                                    <td>19</td>
                                                    <td><i class="mdi mdi-star text-warning"></i> <i
                                                ...
                                                <tr>
                                                    <td><img class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-5.jpg') }}" alt="user"
                                                            width="40"></td>
                                                    <td><a href="javascript:void(0);">Robert N. Carlile</a></td>
                                                    <td><img src="{{ asset('assets/images/flags/russia_flag.jpg') }}" alt=""
                                                            style="width:30px"></td>
                                                    <td>$450</td>
                                                    <td>30</td>
                                                    <td><i class="mdi mdi-star text-warning"></i> <i
                                                ...
                                                <tr>
                                                    <td><img class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt="user"
                                                            width="40"></td>
                                                    <td><a href="javascript:void(0);">Ruby T. Curd</a></td>
                                                    <td><img src="{{ asset('assets/images/flags/italy_flag.jpg') }}" alt=""
                                                            style="width:30px"></td>
                                                    <td>$500</td>
                                                    <td>40</td>
                                                    <td><i class="mdi mdi-star text-warning"></i> <i
                                    ...
                                    <ul class="list-unstyled mb-0 pr-3" id="boxscroll2" tabindex="1"
                                        ...
                                        <li class="p-3">
                                            <div class="media">
                                                <div class="thumb float-left"><a href="#"><img
                                                            ...
                                                            src="{{ asset('assets/images/users/avatar-5.jpg') }}" alt=""></a></div>
                                        ...
                                        <li class="p-3">
                                            <div class="media">
                                                <div class="thumb float-left"><a href="#"><img
                                                            class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-4.jpg') }}" alt=""></a></div>
                                                <div class="media-body">
                                        ...
                                        <li class="p-3">
                                            <div class="media">
                                                <div class="thumb float-left"><a href="#"><img
                                                            class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-3.jpg') }}" alt=""></a></div>
                                                <div class="media-body">
                                        ...
                                        <li class="p-3">
                                            <div class="media">
                                                <div class="thumb float-left"><a href="#"><img
                                                            class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-2.jpg') }}" alt=""></a></div>
                                                <div class="media-body">
                                        ...
                                        <li class="p-3">
                                            <div class="media">
                                                <div class="thumb float-left"><a href="#"><img
                                                            class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-1.jpg') }}" alt=""></a></div>
                                                <div class="media-body">
                                                    <p class="media-heading mb-0">Ruby T. Curd <i
                                                            class="fa fa-circle text-danger mr-1 pull-right"></i>
                                        ...
                                        <li class="p-3">
                                            <div class="media">
                                                <div class="thumb float-left"><a href="#"><img
                                                            class="rounded-circle"
                                                            src="{{ asset('assets/images/users/avatar-6.jpg') }}" alt=""></a></div>
                                                <div class="media-body">
                                                    <p class="media-heading mb-0">Robert N. Carlile <i
                                                            class="fa fa-circle text-success mr-1 pull-right"></i>
                                                    </p><small class="pull-right text-muted">Now</small> <small
